...
public class Ponyville {
    public static void main(String[] args) {
        ...
        for(int i=0; i<6; i++) {
            try {
                ponies[i].attack(ponies[(i + 1) % 6]);
            } catch(RefusalException e) {
                // Really nothing to do... can't force the pony ta attack
                // It's ok that a pony refuses to attack sometimes... but it would
                // be nice to know who/what the refusal was about...
        ...
        // Make them grow plants -- still need to cast grow plants (not a pony.Pony method)
